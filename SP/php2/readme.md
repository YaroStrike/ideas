...
### Тема: Работа с веб-сервером и процесс обработки запросов ###

### Цель: Изучить основы языка сервервного скриптования ###

#### Ход работы ####

##### Задание: #####

> Вариант 1. Измените работу скрипта таким образом, чтобы пользователь мог выбрать имя из списка,
ввести приветствие, нажать кнопку "Обработать данные" и получить приветствие для
выбранного имени.

##### Контрольный пример: #####

> ввожу авыыаваывда в текстбокс, нажимаю кнопку, обновляется заголовок.

##### Системный анализ: #####

> Входные данные: $priv

> Промежуточные данные: $title, $name, $color

> Выходные данные: меняется заголовок <h1>
